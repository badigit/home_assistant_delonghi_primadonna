...
# Alarm bit position -> translation slug. Slugs match
# entity.sensor.device_status.state in translations/en.json and ru.json.
DEVICE_STATUS = {
    0: "empty_water_tank",
...
# Maps to translation slugs in entity.sensor.device_status.state.
MACHINE_STATE = {
    0: "standby",
    1: "turning_on",
    2: "shutting_down",
